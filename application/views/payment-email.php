                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                	<tr>
                                                		<td align="center" colspan="2">
                                                			<h4 class="h4" style="color: #000">Payment Information</h4>
                                                		</td>
                                                	</tr>
                                                    <tr>
                                            			<td>No Order : </td>
                                                    ...
                                                    <tr>
                                            			<td>Payment Date : </td>
                                            			<td><?php echo date('d-m-Y H:i',$this->_payment->date);?></td>
													</tr>
													<tr>
                                            			<td>Account No : </td>
                                            			<td><?php echo $this->_payment->acc_no;?></td>
													</tr>
													<tr>
                                            			<td>Account Name : </td>
                                            			<td><?php echo $this->_payment->acc_name;?></td>
													</tr>
													<tr>
                                            			<td>Bank Name : </td>
                                            			<td><?php echo $this->_payment->bank_name;?></td>
													</tr>
													<tr>
                                            			<td>Amount : </td>
                                            			<td>IDR <?php echo number_format($this->_payment->amount);?></td>
													</tr>
                                                </table>
