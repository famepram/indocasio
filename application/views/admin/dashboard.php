                                            ...
                                            <tbody>
                                                ...
                                                <?php if(!empty($olist)):?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-info" href="<?php echo $this->_root_path.'order/view/'.$o->id;?>"> <span class="fa fa-search"></span></a></td>
                                                    </tr>
                                                    <?php endforeach;?>
                                                <?php else :?>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <?php if(!empty($plist)):?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-info" href="<?php echo $this->_root_path.'product/update/'.$p->id;?>"> <span class="fa fa-search"></span></a></td>
                                                    </tr>
                                                    <?php endforeach;?>
                                                <?php else :?>
                                                <tr>
            ...
            $(document).ready(function(){
                ...
                */
                ...
                //Donut Chart
                  ...
                  //   hideHover: 'auto'
                  // });
                var data_morris2 = JSON.parse('<?php echo json_encode($datavis);?>');
