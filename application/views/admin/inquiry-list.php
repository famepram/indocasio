								  	...
								  	<table class="datatable table table-condensed">
									  	<thead>
										  	<tr>
											  	...
											  	<th class="hidden-xs" width="100">Status</th>
											  	<th width="120">Action</th>
											</tr>
									  	</thead>
									  	<tbody>
									  		<?php $list = $this->mod_inquiry->get_all();?>
									  		<?php if(!empty($list)):?>
									  		<?php $x = 0;?>
										  	...
										  	<tr>
										  		...
										  		<td>
										  			<?php $product = $row->get_product();?>
										  			<?php if($product !== null):?>
										  			<a target="_blank" href="<?php echo $product->get_link();?>"><?php echo $product->code;?></a>
										  			<?php else :?>
													&mdash;
										  			<?php endif;?>
										  		</td>
										  		<td><?php echo $row->get_status_descr();?></td>
											  	<td style="min-width:80px;">
												  	<div class="btn-group">
												  		<a href="<?php echo $page_path.'view/'.$row->id;?>" class="btn btn-success btn-flat" data-toggle="tooltip" data-placement="top" title="View <?php echo $row->name;?>"><i class="fa fa-search"></i></a>
													</div>
											  	</td>
										  	</tr>
										  		<?php endforeach;?>
