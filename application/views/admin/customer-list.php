								  	...
								  	<table class="datatable table table-condensed">
									  	<thead>
										  	<tr>
											  	...
											  	<th class="hidden-xs" width="120">Phone</th>
											  	<th>Action</th>
										  	</tr>
									  	</thead>
									  	<tbody>
									  		<?php $list = $this->mod_customer->get_all();?>
									  		<?php if(!empty($list)):?>
									  		<?php $x = 0;?>
										  	...
										  	<tr>
											  	...
											  	<td style="min-width:80px;">
												  	<div class="btn-group">
													  	<a href="<?php echo $page_path.'view/'.$row->id;?>" class="btn btn-info btn-flat" data-toggle="tooltip" data-placement="top" title="View Detail Customer"><i class="fa fa-search"></i></a>
													</div>
											  	</td>
										  	</tr>
										  		<?php endforeach;?>
