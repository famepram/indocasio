								  	...
								  	<table class="datatable table table-condensed">
									  	<thead>
										  	<tr>
											  	...
											  	<th style="width:150px;" class="hidden-xs">Image</th>
											  	<th>Name</th>
									  	...
									  	<tbody>
										  	...
										  	<tr>
											  	...
											  	<td class="hidden-xs thumbnail"><img src="<?php echo $row->get_img_src(true);?>" style="width:100%;" /></td>
											  	<td><?php echo $row->name;?></td>
											  	<td class="hidden-xs"><?php echo $row->get_parent_name();?></td>
											  	...
											  	<td style="min-width:80px;">
												  	<div class="btn-group">
													  	...
													  	<a href="javsscript:void(0)" data-toggle="tooltip" data-placement="top" title="Delete <?php echo $row->name;?>" data-url="<?php echo $root_path.'category/delete/'.$row->id;?>" class="btn btn-danger btn-del" title="Delete  <?php echo $row->name;?>"><i class="fa fa-trash"></i></a>
												  	</div>
											  	</td>
										  	</tr>
										  		<?php endforeach;?>
