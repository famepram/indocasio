								  	...
								  	<table class="datatable table table-condensed">
									  	<thead>
										  	<tr>
											  	...
											  	<th width="220">Testimoni</th>
											  	<th class="hidden-xs" width="120">Publish</th>
											  	<th class="hidden-xs" width="120">Reff</th>
											  	<th width="120">Action</th>
											</tr>
									  	</thead>
									  	<tbody>
									  		<?php $list = $this->mod_testimoni->get_all();?>
									  		<?php if(!empty($list)):?>
									  		<?php $x = 0;?>
										  	...
										  	<tr>
											  	...
											  	<td>
											  		<div class="checkbox">
	                                                    <input id="<?php echo $row->id;?>" class="status" type="checkbox" value="1" <?php echo $row->status==1?'checked':'';?>> 
	                                                </div>
											  	</td>
											  	<td><?php echo no_order($row->reff);?></td>
											  	<td style="min-width:80px;">
												  	<div class="btn-group">
													  	<a href="javsscript:void(0)" data-toggle="tooltip" data-placement="top" title="Delete <?php echo $row->id;?>" data-url="<?php echo $root_path.'order/delete_testimoni/'.$row->id;?>" class="btn btn-danger btn-del" title="Delete  <?php echo $row->id;?>"><i class="fa fa-trash"></i></a>
												  	</div>
											  	</td>
										  	</tr>
										  		<?php endforeach;?>
		...
		$(document).ready(function(){
            ...
            $('body .status').on('ifChanged', function(event){
            	...
            	var val = 0;
			  	...
			  	var url = "<?php echo $root_path;?>order/testimoni_set/";
