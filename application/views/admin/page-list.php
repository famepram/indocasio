									  	...
									  	<tbody>
										  	...
										  	<tr>
											  	...
											  	<td style="min-width:80px;">
												  	<div class="btn-group">
													  	<a href="<?php echo $page_path.'update/'.$row->id;?>" class="btn btn-success btn-flat" data-toggle="tooltip" data-placement="top" title="Edit Page"><i class="fa fa-pencil"></i></a>
													  	<a href="javsscript:void(0)" data-toggle="tooltip" data-placement="top" title="Delete Page" data-url="<?php echo $root_path.'page/delete/'.$row->id;?>" class="btn btn-danger btn-del" title="Delete Banner"><i class="fa fa-trash"></i></a>
												  	</div>
											  	</td>
										  	</tr>
										  		<?php endforeach;?>
