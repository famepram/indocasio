                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="box">
                            ...
                            <form method="post" role="form" action="<?php echo $root_path;?>province/updater/" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Province Name" value="<?php echo $object!==false?$object->name:'';?>" />
                                    </div>
                                </div>
