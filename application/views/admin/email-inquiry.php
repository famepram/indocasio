                                                            ...
                                                            <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td align="center" valign="top" class="textContent">
                                                                        ...
                                                                        <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-top:20px;margin-bottom:0px;color:#cccccc;line-height:135%;">Informasi Produk</h2>
                                                                                ...
                                                                                <td align="left" class="textContent">
                                                                                    ...
                                                                                    <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                                                                        <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-left:0px;margin-right:10px;">
                                                                                            <?php $product = $this->_inquiry->get_product();?>
                                                                                            <tr>
                                                                                                <td>Nama Produk</td>
                                                                                                <td>&nbsp;:&nbsp;</td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td colspan="3">
                                                                                                    <img src="<?php echo $product->get_img_src(true);?>" /><br/>
                                                                                                    <a href="<?php echo $product->get_link();?>" target="_blank"  >Klik disini untuk lihat produk</a>
                                                                                                </td>
                                                                                             </tr>                                                                                            
                                                                                        </table>
                                                                                    </div>
                                        ...
                                        <tr>
                                            <td align="center" valign="top" class="textContent">
                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000000;line-height:135%;">
                                                    Produk yang anda ingin pesan tersedia. Silahkan melanjutkan pemesanan pada link dibawah ini : <br />
                                                </div>
                                                <table border="0" cellpadding="0" cellspacing="0" width="70%" class="emailButton" style="background-color: #000000;margin-top:25px;">
                                                    <tr>
                                                        <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                                            ...
                                                            href="<?php echo base_url().'product/close_inquiry/'.$this->_inquiry->id;?>" target="_blank">Lanjut Pemesanan</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
