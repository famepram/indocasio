                                ...
                                <td align="center" valign="top">
                                    <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                        <tr>
                                            <td align="center" valign="top" class="textContent">
                                                ...
                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000000;line-height:135%;">
                                                    Kami akan mengecek persediaan barang. dan akan menginformasikan no. rekening untuk pembayaran, sesegera mungkin setelah stok tersedia
                                                </div>
                                                    <?php else : ?>
                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000000;line-height:135%;">
                                                    Kami akan mengecek persediaan barang. dan akan menginformasikan link untuk melakukan pembayaran, sesegera mungkin setelah stok tersedia
                                                </div>    
                                                    <?php endif;?>
                                                <?php elseif($this->_order->status == 1):?>
                                                    <?php if($this->_order->payment_method == 1):?>
                                                        <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000000;line-height:135%;">

                                                                Produk yang anda pesan tersedia. Silahkan lakukan pembayaran Ke No. Rekenining dibawah ini : <br />
                                                                <?php $reks = get_atm_account();?>
                                                                <?php if(!empty($reks)):?>
                                                                    <?php foreach($reks as $rek):?>
                                                                   <br /> Bank <?php echo $rek->bank_name;?> <?php echo $rek->acc_no;?> A/N <?php echo $rek->acc_name;?> 
                                                                    <?php endforeach;?>
                                                                <?php endif;?>
                                                                 
                                                                <br/><br /> Setelah melakukan pembayaran, diharapkan melakukan konfirmasi pembayaran pada link di bawah ini<br />

                                                        </div>
                                                        <!-- CONTENT TABLE // -->
                                                        <table border="0" cellpadding="0" cellspacing="0" width="70%" class="emailButton" style="background-color: #000000;margin-top:25px;">
                                                            <tr>
                                                                <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                                                    <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="<?php echo base_url().'checkout/payment_conf?oid='.$this->_order->id;?>" target="_blank">Payment Confirmation</a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    <?php else : ?>
                                                        <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000000;line-height:135%;">
                                                                ...
                                                                Produk yang anda pesan tersedia. Silahkan melanjutkan pembayaran pada link dibawah ini : <br />
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" width="70%" class="emailButton" style="background-color: #000000;margin-top:25px;">
                                                            <tr>
                                                                <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                                                    <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="<?php echo base_url().'checkout/cc_payment/'.$this->_order->id;?>" target="_blank">Lanjut Ke Pembayaran</a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    <?php endif;?>
                                                <?php elseif($this->_order->status == 2):?>
                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000000;line-height:135%;">
                                                    Kami akan melakukan pengecekan pembayaran. dan akan segera memproses pesanan segera setelah pembaran di terima 
                                                </div>
                                                <?php elseif($this->_order->status == 3):?>
                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000000;line-height:135%;">
                                                    Pesanan anda dalam proses. kami akan segera mengirimkan pesanan <br />

                                                </div>
                                                <?php elseif($this->_order->status == 4):?>
                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000000;line-height:135%;">
                                                    Pesanan anda dalam proses pengiriman. berikut no. resi pengiriman pesanan anda <br />
                                                    No.resi : <?php echo $this->_order->track_no;?>
                                                </div>
                                                <?php elseif($this->_order->status == 5):?>
                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000000;line-height:135%;">
                                                    Berdasarkan informasi yang kami terima dari pihak kurir, bahwa pesanan anda telah terkirim. Dengan ini proses pesanan selesai.
                                                </div>
                                                <?php elseif($this->_order->status == 6):?>
                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000000;line-height:135%;">
                                                    Pesanan di batalkan.
                                                </div>
                                                <?php endif;?>
                                        ...
                                        <tr>
                                            <td align="center" valign="top" class="textContent">
                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000000;line-height:135%;">
                                                    <a href="<?php echo base_url().'order/view/'.$this->_order->id;?>" target="_blank">Klik disini untuk melihat order di browser</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
