									  	...
									  	<tbody>
										  	...
										  	<tr>
											  	...
											  	<td>
											  		...
											  		<?php else:?>
											  			<label class="label label-default">Not Active</label>
											  		<?php endif;?>
											  	</td>
											  	<td style="min-width:80px;">
												  	<div class="btn-group">
													  	<a href="<?php echo $page_path.'update/'.$row->id;?>" class="btn btn-success btn-flat" data-toggle="tooltip" data-placement="top" title="Edit Ads"><i class="fa fa-pencil"></i></a>
													  	<a href="javsscript:void(0)" data-toggle="tooltip" data-placement="top" title="Delete Ads" data-url="<?php echo $root_path.'account/delete/'.$row->id;?>" class="btn btn-danger btn-del" title="Delete Ads"><i class="fa fa-trash"></i></a>
												  	</div>
											  	</td>
										  	</tr>
										  		<?php endforeach;?>
