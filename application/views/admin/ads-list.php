										  	...
										  	<tr>
											  	...
											  	<td style="min-width:80px;">
												  	<div class="btn-group">
													  	...
													  	<a href="javsscript:void(0)" data-toggle="tooltip" data-placement="top" title="Delete Ads" data-url="<?php echo $root_path.'ads/delete/'.$row->id;?>" class="btn btn-danger btn-del" title="Delete Ads"><i class="fa fa-trash"></i></a>
												  	</div>
											  	</td>
										  	</tr>
										  		<?php endforeach;?>
