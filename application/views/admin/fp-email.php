                    	...
                    	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateContainer">
                        	<tr>
                            	<td align="center" valign="top">
                                	...
                                	<table border="0" cellpadding="0" cellspacing="20" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            
                                            	<!-- // Begin Module: Standard Header Image \\ -->
                                            	<img src="<?php echo base_url().'assets/img/';?>logo-black.png" style="max-height:100px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                	<tr>
                                                		<td align="center" colspan="2">
                                                			<h4 class="h4" style="color: #000">Reset Password</h4>
                                                		</td>
                                                	</tr>
                                                	<tr>
                                                		<td align="center" colspan="2">
                                                			<span>
                                                				<?php $link = base_url().'reset_pass/?token='.$this->_customer->fp_token;?>
                                                				Click <a href="<?php echo $link;?>">Here</a> or link below to reset your password <br>
		                                                            ...
		                                                            <table border="0" cellpadding="30" cellspacing="0" width="100%">
		                                                                <tr>
		                                                                    <td valign="top" bgcolor="#ffffff">
		                                                                        ...
		                                                                        <div>Copyright &#169; 2015 <a href="<?php echo base_url();?>" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;"><?php echo GG_PREFIX_TITLE;?></span></a>. All&nbsp;rights&nbsp;reserved.</div>
