								  	...
								  	<table id="product-datatable" class="table table-condensed">
									  	...
									  	<tbody>
										  	...
										  	<tr>
											  	...
											  	<td class="hidden-xs"><?php echo $row->inquiry == 1 ? 'Yes':'No';?></td>
											  	<?php if(!empty($this->category)):?>
											  	<td class="hidden-xs">
											  		<div class="btn-group">
											  	...
											  	<td style="min-width:80px;padding:0px 10px;text-align:left;">
												  	...
												  	<?php $ext_get = isset($_GET['category'])? '?category='.$_GET['category']:'';?>
												  	<div class="btn-group">
													  	<a href="<?php echo $page_path.'duplicate/'.$row->id.$ext_get;?>" class="btn btn-info btn-flat" data-toggle="tooltip" data-placement="top" title="Duplicate <?php echo $row->name;?>"><i class="fa fa-copy"></i></a>
													  	...
													  	<a href="javsscript:void(0)" data-toggle="tooltip" data-placement="top" title="Delete <?php echo $row->name;?>" data-url="<?php echo $root_path.'product/delete/'.$row->id.$ext_get;?>" class="btn btn-danger btn-del" title="Delete  <?php echo $row->name;?>"><i class="fa fa-trash"></i></a>
												  	</div>
											  	</td>
										  	</tr>
										  		<?php endforeach;?>
