    ...
    <body class="skin-blue">
        <div class="wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-list"></i>&nbsp; Marketplace List</a></li>
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="box">
                            ...
                            <form method="post" role="form" action="<?php echo $root_path;?>marketplace/updater/" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <div class="fileinput <?php echo $class;?>" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail" style="width: 350px; height: 90px;">
                                                    <img src="http://placehold.it/350x90&text=350x90" alt="..." style="width:100%;">                                                                
                                                </div>
