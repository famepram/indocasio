										  	...
										  	<tr>
											  	...
											  	<td style="min-width:80px;">
												  	<div class="btn-group">
													  	...
													  	<a href="javsscript:void(0)" data-toggle="tooltip" data-placement="top" title="Delete Banner" data-url="<?php echo $root_path.'banner/delete/'.$row->id;?>" class="btn btn-danger btn-del" title="Delete Banner"><i class="fa fa-trash"></i></a>
												  	</div>
											  	</td>
										  	</tr>
										  		<?php endforeach;?>
