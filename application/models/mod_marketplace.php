<?php
class Mod_marketplace extends CI_Model {
    
    var $table = 'marketplace';
    
    var $dir_img = './uploads/marketplace/';
    
    var $dir_img_thumb = './uploads/marketplace/thumb/';
    ...
    public function get_img_src($thumb=false){
        $img ='no-img.jpg';
        $path = base_url().'uploads/marketplace/';
        if($thumb)
        {
            $path.='thumb/';
        }
